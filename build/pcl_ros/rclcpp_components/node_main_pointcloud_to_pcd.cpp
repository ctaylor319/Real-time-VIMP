...
#define NODE_MAIN_LOGGER_NAME "pointcloud_to_pcd"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libpointcloud_to_pcd_lib.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<pcl_ros::PointCloudToPCD>";
